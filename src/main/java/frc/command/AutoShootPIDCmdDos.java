...
public class AutoShootPIDCmdDos extends Command{
    ...
    public AutoShootPIDCmdDos(ShooterSubsystem shooterSubsytem, double rpm, LimelightVisionSubsystem limelightSubsystem){
    ...
    public void execute(){
      ...
      //  shootingRPM = rpm;
        ...
        if(shooterSubsytem.isAtTargetRPM(rpm)){
