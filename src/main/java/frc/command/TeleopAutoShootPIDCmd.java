...
public class TeleopAutoShootPIDCmd extends Command{
    ...
    public TeleopAutoShootPIDCmd(ShooterSubsystem shooterSubsytem, double rpm, LimelightVisionSubsystem limelightSubsystem){
